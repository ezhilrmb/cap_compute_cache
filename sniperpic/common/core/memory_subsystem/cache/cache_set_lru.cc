...
UInt32
CacheSetLRU::getReplacementIndex(CacheCntlr *cntlr, int avoid_index, int avoid_index2)
{
   ...
   {
      UInt32 index = ((avoid_index != 0) && (avoid_index2 != 0)) ? 0 : 1;
      UInt8 max_bits = 0;
      for (UInt32 i = 0; (i < m_associativity) && (i!= avoid_index) && (i!= avoid_index2); i++)
      {
