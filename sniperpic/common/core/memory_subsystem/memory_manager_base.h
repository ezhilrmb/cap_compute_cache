...
,IntPtr other_pic_address = 0, IntPtr other_pic_address2 = 0) = 0;
      ...
      static MemoryManagerBase* createMMU(String protocol_type,
			...
			//#ifdef PIC_IS_MICROBENCH
				virtual void create_microbench_instructions() =0;
				virtual bool more_microbench_loops() =0;
				virtual IntPtr microbench_target_ins_cnt() = 0;
			//#endif
};
